...
// ¿Cómo funciona el código anterior con Math.random?
// Suponiendo que min = 5 y max = 60 primero se haría: Math.random()*(60-5) Lo que da un número entre 0 y 55 (con números decimales). Entonces sumamos ‘min=5’, para tener un número entre 5 y 60, todavía con decimales y por último, utilizamos Math.round() para eliminar los decimales.