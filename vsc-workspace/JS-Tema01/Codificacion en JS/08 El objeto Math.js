...
// Las funciones trigonométricas (sin(), cos(), tan(), asin(), acos(), atan(), atan2()) devuelven ángulos en radianes. Para convertir radianes a grados, se multiplican los radianes por (180 / Math.PI). Para la conversión inversa se divide.
